...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1.web", "2.ide", "3.terminal", "4.chat", "5.files", "6.other" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Ctrl", "Mod1"   }, "a", function () awful.util.spawn("/usr/bin/deepin-screenshot")                end,
              {description = "select previous", group = "layout"}),
...
awful.rules.rules = {
    ...
    --{ rule = { class = "URxvt" },
    --  properties = { screen = 1, tag = "3.terminal" } },

    { rule = { class = "Eclipse" },
      properties = { screen = 1, tag = "2.ide" } },

    { rule = { class = "Thunar" },
      properties = { screen = 1, tag = "5.files" } },
